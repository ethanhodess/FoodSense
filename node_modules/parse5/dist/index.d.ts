...
export { type DefaultTreeAdapterMap, defaultTreeAdapter } from 'parse5/dist/tree-adapters/default.js';
export type * as DefaultTreeAdapterTypes from 'parse5/dist/tree-adapters/default.js';
export type { TreeAdapter, TreeAdapterTypeMap } from 'parse5/dist/tree-adapters/interface.js';
export { type ParserOptions, /** @internal */ Parser } from 'parse5/dist/parser/index.js';
export { serialize, serializeOuter, type SerializerOptions } from 'parse5/dist/serializer/index.js';
export { ERR as ErrorCodes, type ParserError, type ParserErrorHandler } from 'parse5/dist/common/error-codes.js';
/** @internal */
...
/** @internal */
export { Tokenizer, type TokenizerOptions, TokenizerMode, type TokenHandler } from 'parse5/dist/tokenizer/index.js';
/**
