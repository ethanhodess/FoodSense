...
import { RouteParams, RouteSegments, Routes, UnknownOutputParams } from 'expo-router/src/types';
type SearchParams = Record<string, string | string[]>;
export declare function useRootNavigationState(): import("expo-router/src/fork/getStateFromPath").ResultState;
export declare function useRouteInfo(): import("expo-router/src/LocationProvider").UrlObject;
